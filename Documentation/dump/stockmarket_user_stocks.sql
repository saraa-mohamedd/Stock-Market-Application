...
CREATE TABLE `user_stocks` (
  ...
  KEY `company_name_idx` (`stockCompany`),
  CONSTRAINT `company_name` FOREIGN KEY (`stockCompany`) REFERENCES `stocks` (`company`),
...
INSERT INTO `user_stocks` VALUES ('saraahmed','BABA',243.817,26);
